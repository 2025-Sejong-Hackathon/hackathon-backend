package christmas.christmas_backend.global.aop;
...
public class LayerLoggingAspect {
     ...
     * Controller Layer
     */
    @Around("execution(christmas.christmas_backend..controller..* *(..))")
     ...
     * Service Layer
     */
    @Around("execution(* christmas.christmas_backend..service..*.*(..))")
     ...
     * Repository Layer
     */
    @Around("execution(* christmas.christmas_backend..repository..*.*(..))")
